...
public partial class OilPaintingArt2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OilPaintingArtId).HasName("PK__OilPaint__708184D8112EEF7A");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B46DEC1D68");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586A9F74BC4");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33A995CCE7").IsUnique();
